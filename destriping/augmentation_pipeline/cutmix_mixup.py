...
def generate_augmented_images(dataset, num_samples, augmentation_type="cutmix", alpha=0.5, size=16):
    augmented_images = []
...
def visualize_augmentations(dataset, indices, augmentation_function):
    ...
    for row, idx in enumerate(indices):
        ...
        augmented_image = augmentation_function(dataset, idx, random.randint(0, len(dataset) - 1))
