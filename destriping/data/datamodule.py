...
from .data_cube import HyperSpectralDataCube
...
class DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage="fit"):
        ...
        self.train_dataset = HyperSpectralDataCube(
            self.cubes_filename,
            train=True,
        ...
        self.val_dataset = HyperSpectralDataCube(
        ...
        self.test_dataset = HyperSpectralDataCube(
            self.val_cubes_filename,
            train=False,
            percentage_of_empty_cubes=self.percentage_of_empty_cubes,
            train_len=self.train_len,
