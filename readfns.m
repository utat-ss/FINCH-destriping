...
clear fns;
namelist2 = dir('/Users/prithviseran/Documents/GitHub/GRN/GRN-HSI-Denoising/data/datasets/raw_clean_ICVL_test/*.mat');
len = length(namelist2);
for i = 1:len
    fns{i} = namelist2(i).name;
    fns = fns';
end
save('/Users/prithviseran/Documents/GitHub/GRN/GRN-HSI-Denoising/test_fns.mat','fns') 
