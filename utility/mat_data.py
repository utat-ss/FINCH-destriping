...
def create_icvl_sr():
    basedir = '/Users/prithviseran/Documents/UTAT/SERT'
    datadir = join(basedir, '/data')
    newdir = join(basedir, 'new')

    print(basedir + datadir)

    #fnames = os.listdir(datadir)
    f = open("/Users/prithviseran/Documents/UTAT/SERT/utility/icvl_partition/test_list.txt")
    fnames = f.readlines()
    ...
    create_mat_dataset(basedir + datadir, fnames, newdir, 'input', func=func)
...
if __name__ == '__main__':
    create_icvl_sr()
    #test = loadmat("/Users/prithviseran/Documents/UTAT/SERT/new/first.mat")
    #print(test)
    #generate_icvl_png()
    #copydata()
    pass
